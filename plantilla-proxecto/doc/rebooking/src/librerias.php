...
<head>
    ...
    <script src="js/mostrarLibrerias.js" defer></script>
...
<body>
    <header>
        ...
        <li><a href="index.php">Inicio</a></li>
            ...
            <li class="menuHover"><a href="librerias.php">Librerías</a></li>
        </ul>
        <?php
    ...
    <main>
        <h2 class="tituloLibrerias">Librerías</h2>
        <section class="lista-librerias">
